...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{DATAENTRY_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{DATAENTRY_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
dataentry_server.pl - Catalyst Testserver

=head1 SYNOPSIS

dataentry_server.pl [options]
